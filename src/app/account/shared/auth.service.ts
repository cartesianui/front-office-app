...
export class AuthService {
  ...
  constructor(private _router: Router, private _utilsService: UtilsService, private _tokenService: TokenService, private _logService: LogService) {
    this.clear();
  }

  logout(reload?: boolean): void {
    axis.auth.clearToken();
    axis.utils.setCookieValue(AppConstants.authorization.encryptedAuthTokenName, undefined, undefined, axis.appPath);
    if (reload !== false) {
